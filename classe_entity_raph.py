...
from math import *
from quete_secondaire import QueteSecondaire
...
class PNJ(Entity):
    def __init__(self, name, x, y, type, screen,scale,parole):
        ...
        self.name = name
        self.quete_secondaire = QueteSecondaire(
            nom="Trouver l’amulette",
            declencheur_pnj=self,
            objectif="Récupérer l’amulette dans la grotte",
            recompense="Potion rare"
        )
